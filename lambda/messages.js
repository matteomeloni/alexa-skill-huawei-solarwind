module.exports = {
  ...
  POWER_PRODUCING: (power) => `In questo momento il tuo impianto sta producendo ${power} kilowatt.`,
  POWER_NOT_PRODUCING: "In questo momento l'impianto non sta producendo energia.",
  REPROMPT_MORE: 'Vuoi sapere altro?',

  DAILY_ENERGY: (energy) => `Oggi il tuo impianto ha prodotto ${energy} kilowattora.`,
